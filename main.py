...
while run:
    ...
    def lotado():
        if numfila >= 11:
            ...
            texto_formatado2 = fonte.render(texto2, True, (255, 255, 255))
    ...
    def instrucoes():
        ...
        texto_formatado3 = fonte3.render(texto3, True, (255, 255, 255))
        texto4 = 'Pressione TAB para enviar o paciente com maior prioridade para o atendimento'
        texto_formatado4 = fonte3.render(texto4, True, (255, 255, 255))
